...
#'
#' `medication_bundles` is a [fhir_bundle_list-class] containing [fhir_bundle_serialized-class] objects
#' representing FHIR bundles as returned by [fhir_search()].
#'
#' It contains 1 bundle with MedicationStatement resources representing Medications with Snomed CT code
...
#'
#' @format [fhir_bundle_list-class] containing 1 [fhir_bundle_serialized-class] object.
#' \emph{They have to be unserialized before use, see Examples!}
#'
#' @examples
...
#'
#' bundles <- fhir_search(search_request, max_bundles = 1)
#'
...
#' when direct access to a FHIR server is not possible.
#'
#' patient_bundles is a [fhir_bundle_list-class] containing [fhir_bundle_serialized-class] objects
#' representing FHIR bundles as returned by [fhir_search()].
#'
#' It contains 2 bundles with Patient resources.
#'
#' @format [fhir_bundle_list-class] containing 2 [fhir_bundle_serialized-class] objects.
#' \emph{They have to be unserialized before use, see Examples!}
#'
#' @examples
#' #unserialize xml objects before doing anything else with them!
