...
```{r}
pat_table_description <- fhir_table_description(resource = "Patient",
										  cols = list(id = "id",
									  				  gender = "gender", 
												      name = "name/family",
												      city = "address/city"))
...
```{r}
meds <- fhir_table_description(resource = "MedicationStatement",
...
```{r}
desc1 <- fhir_table_description(resource = "Patient",
							style = fhir_style(sep = " | "))
...
```{r}
desc2 <- fhir_table_description(resource = "Patient",
							style = fhir_style(sep = " | ",
											   brackets = c("[", "]"))
							)
