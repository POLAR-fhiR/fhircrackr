...
1. First of all, you need the endpoint of the fhir server you want to access. If you don't have you own fhir server, you can use one of the publicly available servers, such as http://hapi.fhir.org/baseR4 or http://fhir.hl7.de:8080/.The endpoint of a fhir server is often referred to as [base].
