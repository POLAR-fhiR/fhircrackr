...
Uploading resources that stand alone to a server is easy, as you've seen above. Matters get a lot more complicated, however, when resources contain references to other resources, e.g. a MedicationAdministration resource that links to a Patient resource. 
