...
The third problem is that large amounts of resources can at some point exceed the working memory you have available. There are three solutions to those problems:

### 1. Download trimmed resources using the `_elements` search parameter
...
### 2. Use the save_to_disc argument of fhir_search()
