...
Now our `design` needs two `fhir_table_description`s (called `MedicationStatements` and `Patients` in our example), one for the MedicationStatement resources and one for the Patient resources:
